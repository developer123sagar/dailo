...
!(function (a) {
  ...
  function i(t, e) {
    ...
    switch ((s(t), r)) {
      ...
      case "out-down":
      case "out-left":
        t.addclassName("imgfix-" + r);
        break;
      case "dynamic":
        t.addclassName("imgfix-in-up"),
          a(i).on("mouseenter", t, function (t) {
            ...
            a(this)
              ...
              .removeclassName("imgfix-in-up-right"),
              a(this)
                .find(".imgfix_cover_wrapper")
                .removeclassName("imgfix-in-up-left"),
              a(this)
                .find(".imgfix_cover_wrapper")
                .removeclassName("imgfix-in-down-right"),
              a(this)
                .find(".imgfix_cover_wrapper")
                .removeclassName("imgfix-in-down-left");
            ...
            if (!i.find(":hover").length) {
              ...
              (d =
                f < 0.1 * t.data.height()
                  ...
                  ? "left"
                  : "right"),
                t.data.addclassName("imgfix-in-" + d),
  ...
  function s(a, t) {
    "imgfix-in-up" != t && a.removeclassName("imgfix-in-up"),
      "imgfix-in-right" != t && a.removeclassName("imgfix-in-right"),
      "imgfix-in-down" != t && a.removeclassName("imgfix-in-down"),
      "imgfix-in-left" != t && a.removeclassName("imgfix-in-left"),
      "imgfix-in-up-left" != t && a.removeclassName("imgfix-in-up-left"),
      "imgfix-in-up-right" != t && a.removeclassName("imgfix-in-up-right"),
      "imgfix-in-down-left" != t && a.removeclassName("imgfix-in-down-left"),
      "imgfix-in-down-right" != t && a.removeclassName("imgfix-in-down-right"),
      a.removeclassName("imgfix-out-up"),
      a.removeclassName("imgfix-out-right"),
      a.removeclassName("imgfix-out-down"),
      a.removeclassName("imgfix-out-left");
  }
  function r(t, e) {
  ...
  var l = {
    ...
    init: function (e, s) {
        ...
        (l = {
          ...
          protectaspectratio:
            l.protectaspectratio || l.protectAspectRatio
              ...
              : null,
          coverclassName:
            l.coverclassName || l.coverclassName
              ? l.coverclassName || l.coverclassName
              : "",
          cover: {
      ...
      for (var n = 0; n < d.length; n++) {
        var o = a(d[n]);
        o.addclassName("imgfix_top_container");
        ...
        if (s)
          null == o.data("fix-img") && o.data("fix-img", ""),
            ...
            o.data(
              "fix-cover",
              l.coverclassName ? l.coverclassName : o.data("fix-cover")
            ),
            o.data(
              "fix-cover-fade",
        ...
        if (
          ...
          0 == o.find("img").length
            ? o.append(
                '<img className="imgfix_src_img" src="' +
                  o.data("fix-img") +
                  '" />'
              )
            : a(o.find("img")[0]).addclassName("imgfix_src_img");
        ...
        if (
          (u &&
            o.wrapInner(
              '<div id="imgfix_wrapper_layer_' +
                ...
                "_" +
                n +
                '" className="imgfix_wrapper_layer" style="position: relative; padding: 0; margin: 0; width: 100%; height: 100%; overflow: hidden;"></div>'
            ),
          t(
          ...
          (h =
            ...
            o.data("fix-cover").split("#").length > 1
              ? o.data("fix-cover")
              : "." + o.data("fix-cover")),
            u && o.find(h).wrap('<div className="imgfix_cover_wrapper"></div>');
